...
- (void)getHttp:(NSString *)httpUrl complete:(NetworkCompleteHandler)handler error:(NetworkCompleteError)handleError {
    ...
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json", @"text/json",@"text/html", @"text/plain",@"application/x-javascript",@"application/zip",nil];
